...
const Configuration: React.FC = () => {
    ...
    useEffect(() => {
        const fetchBankConfig = async () => {
            ...
            try {
                ...
                // Initialize projectId state from config if it exists
                if (config.projectId) {
    ...
    const handleSaveProjectId = async () => {
        ...
        // Update bank config with new projectId
        const updatedConfig = {
            ...bankConfig,
            projectId
        };
        ...
        try {
            ...
            if (success) {
                ...
                setProjectIdError('Failed to save Project ID');
            }
        } catch (error) {
            console.error('Error saving Project ID:', error);
            setProjectIdError('Error saving Project ID');
        } finally {
            setIsSaving(false);
        }
    };
                ...
                {isLoading ? (
                    ...
                    <Box sx={{display: 'flex', flexDirection: 'column', gap: 2}}>
                        <TextField
                            ...
                            helperText={projectIdError || "Enter your project identifier"}
                            disabled={isSaving}
                        />
                        <Button
                            variant="contained"
                            ...
                            disabled={isLoading || isSaving || !!projectIdError}
                        >
                            Save Project ID
                        </Button>
                    </Box>
